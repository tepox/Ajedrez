defmodule Ajedrez do
  ...
  def inicia do
    ...
    juego(tablero, jugador1, jugador2)
  end

  defp juego(tablero, jugador_movimiento, jugador_espera) do
    ...
    if valida_movimiento(movimiento_jugador) do
      case TableroControl.moviento(
        ...
        {:ok, jugador1, jugador2, tablero} ->
          imprime_jugador(jugador1)
          imprime_jugador(jugador2)
          imprime_tablero(tablero)
          if TableroControl.en_jaque_mate?(tablero, jugador2, jugador1) do
            IO.puts("gana jugador #{jugador1.nombre}")
          else
          juego(tablero, jugador2, jugador1)
          end
